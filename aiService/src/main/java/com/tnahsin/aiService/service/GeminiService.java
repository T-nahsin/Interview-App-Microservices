...
public class  GeminiService {
    ...
    public String generateQuestion(String role, String level) {
        ...
        String res = redisService.get("Question for "+role+" of level "+level);
        if(res != null) {
            return res;
        }else {
            ...
            try {
                ...
                if (text != null) {
                    redisService.set("Question for "+role+" of level "+level, text, 300l);
                }
                return text;
    ...
    public String getScores(String question, String answer) {
        String res = redisService.get("Get marks for " +question+" answer "+answer);
        if(res != null){
            return res;
        }else {
            Map<String, Object> requestBody = Map.of(
            ...
            try {
                ...
                if(text != null) {
                    redisService.set("Get marks for " +question+" answer "+answer,text,300l);
                }
                return text;
            } catch (JsonProcessingException e) {
                throw new RuntimeException(e);
    ...
    public String getSuggestion(String question, String answer) {
        String res = redisService.get("Get suggestion of "+answer+" for "+question+" this question");
        if(res != null) {
            return res;
        }else {
            Map<String, Object> requestBody = Map.of(
            ...
            try {
                ...
                if(text != null) {
                    redisService.set("Get suggestion of "+answer+" for "+question+" this question", text, 300l);
                }
                return text;
            } catch (JsonProcessingException e) {
                throw new RuntimeException(e);
    ...
    public List<String> generateInterviewQuestions(String role, String level, String mode) {
        List<String> res = redisService.getList("Get "+mode+" questions of "+role+" of "+level);
        if(res != null){
            return res;
        }else {
    ...
    public String evaluateResume(String text, String role) {
        String res = redisService.get("Resume "+text+"role "+role);
        if (res != null) {
            return res;
        } else {
            Map<String, Object> requestBody = Map.of(
                    "contents", new Object[]{
                            Map.of("parts", new Object[]{
                                    Map.of("text", "Evaluate this resume: /n"
                                            +text+" for job role "
                                            +role+" /n Only give me the result of evaluation in 30 words ," +
                                            "nothing else!!" )
                            })
                    }
            );
            ...
            try {
                ...
                if (result != null) {
                    redisService.set("Resume "+text+"role "+role, result, 300l);
                }
                return result;
            } catch (JsonProcessingException e) {
                throw new RuntimeException(e);
